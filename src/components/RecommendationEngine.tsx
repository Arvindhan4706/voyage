    ...
    <section className="py-24 px-4 max-w-7xl mx-auto relative z-10">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
          Interactive <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-blue to-cyan-glow">AI Engine</span>
        </h2>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto">
          Input your preferences and watch our Machine Learning models generate the perfect itinerary in real-time.
        </p>
      </div>
        ...
        <div className="lg:col-span-4 glass-panel p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-cyan-500">
            ...
            <div>
              ...
              <input type="number" defaultValue={5} className="w-full bg-white/5 border border-white/10 rounded-xl p-3 text-white focus:outline-none focus:border-cyan-500" />
            </div>
            ...
            >
              {isGenerating ? <><Loader2 className="animate-spin" /> Analyzing 10k+ Datapoints...</> : "Generate Journey"}
            </button>
          </div>
        </div>
          ...
          <AnimatePresence>
            {isGenerating && (
              ...
              >
                ...
                <h3 className="text-cyan-400 mt-8 font-mono text-lg animate-pulse">Computing Matrix Factorization...</h3>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            {showResults && (
              ...
              >
                <div className="flex justify-between items-end mb-8">
                  <h3 className="text-3xl font-bold text-white">Top Match: <span className="text-cyan-400">Bali, Indonesia</span></h3>
                  <div className="text-right">
                    <div className="text-sm text-gray-400">AI Confidence Score</div>
                    <div className="text-3xl font-black text-green-400">98.4%</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="glass-panel p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-bold text-white">₹38,500</div>
                    </div>
                  </div>
                  <div className="glass-panel p-4 flex items-center gap-4">
                    <div className="p-3 bg-purple-500/20 rounded-lg text-purple-400"><MapPin /></div>
                    <div>
                      <div className="text-sm text-gray-400">Best Attractions</div>
                      <div className="text-xl font-bold text-white">Ubud, Seminyak</div>
                    </div>
                  </div>
                  <div className="glass-panel p-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-bold text-white">28°C, Sunny</div>
                    </div>
                  </div>
                </div>

                <div className="glass-panel p-6">
                  <h4 className="text-lg font-bold text-white mb-4">Cost Breakdown Prediction</h4>
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between text-sm mb-1 text-gray-300"><span>Flights</span><span>₹15,000</span></div>
                      <div className="w-full h-2 bg-gray-700 rounded-full"><div className="h-2 bg-blue-500 rounded-full" style={{ width: '40%' }}></div></div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm mb-1 text-gray-300"><span>Accommodation</span><span>₹12,000</span></div>
                      <div className="w-full h-2 bg-gray-700 rounded-full"><div className="h-2 bg-purple-500 rounded-full" style={{ width: '30%' }}></div></div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm mb-1 text-gray-300"><span>Food & Activities</span><span>₹11,500</span></div>
                      <div className="w-full h-2 bg-gray-700 rounded-full"><div className="h-2 bg-green-500 rounded-full" style={{ width: '30%' }}></div></div>
                    </div>
                  </div>
                </div>
